...
\chapter{Resultados Obtenidos}
	Para hablar acerca de resultados en cuanto a la eficacia de los algoritmos en reducir la evaluación de la función objetivo, se diseñó un conjunto de casos de prueba a ser pasado como entrada en varias corridas de los mismos. Dicho conjunto fue generado de manera aleatoria.
	
	Se muestran algunos detalles de la salida, los casos están enumerados de $1$ a $n$. Como se puede apreciar, dada la aleatoriedad inherente a la metaheurística empleada, quedan distintos casos de prueba en el conjunto final. Sin embargo cada salida tiene un aspecto en común que se aprecia en las figuras a continuación: todos los conjuntos tienen igual cantidad de casos finales.
	...
	Veamos otros aspectos a destacar para comprender el porqué sucede esto. A continuación la evaluación de la función objetivo en cada en cada corrida de GRASP con dicho conjunto de casos de prueba.
