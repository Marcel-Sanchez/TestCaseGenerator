...
namespace Probador
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            // mis casos
            Console.WriteLine(Anagramas.CantidadEnCadena("momom")); // 12
            Console.WriteLine(Anagramas.CantidadEnCadena("ada")); // 2
            Console.WriteLine(Anagramas.CantidadEnCadena("bebe")); // 5
            Console.WriteLine(Anagramas.CantidadEnCadena("locura")); // 0
            Console.WriteLine(Anagramas.CantidadEnCadena("ccccc")); // 20
